...
index=["coluor","colour_name","hex","R","G","B"]
...
while(1):
    ...
    if (clicked):
        ...
        #cv2.rectangle(image, startpoint, endpoint, colour, thickness)-1 fills entire rectangle 
        cv2.rectangle(img,(20,20), (750,60), (b,g,r), -1)

        #Creating text string to display( Colour name and RGB values )
